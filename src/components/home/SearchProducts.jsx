...
return;
  ...
  const handleSuggestionClick = (text) => {
    ...
    router.push(`/jeans?search=${encodeURIComponent(text)}`);
  ...
  return (
    <div className="position-relative w-100 mx-auto pb-2 px-2" ref={containerRef} style={{ maxWidth: "800px" }}>
      <input
              ...
              <ul className="list-group">
                {products.map((item) => (
                  <li
                    ...
                    onClick={() => router.push(`/product/productDesc/${item.id}`)}
                  >
                    <img
                      src={item.photo}
                      alt=""
